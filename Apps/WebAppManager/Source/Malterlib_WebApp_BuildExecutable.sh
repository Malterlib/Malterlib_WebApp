...
MTool BuildDependencies "OutputFile=`ConvertPath \"$ScriptDependencyFile\"`" "Output:`ConvertPath \"$OutputBundleTar\"`" "Input:`ConvertPath \"${BASH_SOURCE[0]}\"`" "${InputOptions[@]}" "Find:`ConvertPath \"$AppDir\"`/*;RIF;33;$ExcludePatterns"
