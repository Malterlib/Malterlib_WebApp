...
{
	TCFuture<uint32> CWebCertificateManagerActor::fp_CommandLine_DomainList(CEJSON const &_Params, NStorage::TCSharedPointer<CCommandLineControl> const &_pCommandLine)
	{
		...
		for (auto &Domain : mp_Domains)
		{
			...
			TableRenderer.f_AddRow
				(
				 	...
				 	, Domain.m_Settings.m_Location_NgnixPid ? *Domain.m_Settings.m_Location_NgnixPid : "DISABLED"
